...
export const addBookMark = async (userEmail, news) => {
    ...
    console.log(body);
    let response = await apiClient.post(`${API_BASE}/addBookMark`, body);
    return response.data;
};

export const deleteBookMark = async (userEmail, url) => {
    let body = { userEmail,url};
    let response = await apiClient.post(`${API_BASE}/deleteBookMark`,body);
...
export const getBookMarks = async (userEmail) => {
    let body={userEmail};
    console.log(body);
    let response = await apiClient.post(`${API_BASE}/getBookMarks`, body);
    return response.data;
};
